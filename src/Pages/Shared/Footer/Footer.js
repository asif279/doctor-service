...
const Footer = () => {
    return (
        ...
        <footer  className="footer ity   p-10 bg-accent text-base-content">
        <h1 className="title">Doctor Service</h1>
  <div>
    <span className="footer-title title11">Services</span> 
    <Link href='/home' className="link link-hover">Home</Link> 
    <Link href='/'  className="link link-hover">HealthCare</Link> 
    <Link href='/appointment' className="link link-hover">Appointment</Link> 
   
  </div> 
  <div>
    <span className="footer-title title11">Company</span> 
  ...
  <div>
    <span className="footer-title title11">Social</span> 
